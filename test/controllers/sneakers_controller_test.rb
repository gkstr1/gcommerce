...
class SneakersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sneaker" do
    assert_difference('Sneaker.count') do
      post sneakers_url, params: { sneaker: { color: @sneaker.color, description: @sneaker.description, price: @sneaker.price, release_year: @sneaker.release_year, size: @sneaker.size, title: @sneaker.title } }
    end
  ...
  test "should update sneaker" do
    patch sneaker_url(@sneaker), params: { sneaker: { color: @sneaker.color, description: @sneaker.description, price: @sneaker.price, release_year: @sneaker.release_year, size: @sneaker.size, title: @sneaker.title } }
